...
class AboutTuples(Koan):
    ...
    def test_tuples_of_one_look_peculiar(self):
        ...
        self.assertEqual(type((1,)), (1,).__class__)
        self.assertEqual(type(("I'm a tuple",)), ("I'm a tuple",).__class__)
        self.assertEqual(type("Not a tuple"), ("Not a tuple").__class__)
    ...
    def test_tuples_are_good_for_representing_records(self):
        locations = [("Illuminati HQ", (38, 52, 15.56, 'N'), (77, 3, 21.46, 'W')),
